...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Andraxvpn/Andrax-script/main"
...
wget raw.githubusercontent.com/Andraxvpn/Andrax-script/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
