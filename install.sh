...
# Brief delay before continuing with the script
sleep 2
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Andraxvpn/Andrax-script/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Andraxvpn/Andrax-script/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/Andraxvpn/Andrax-script/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Andraxvpn/Andrax-script/main/izin"
...
TIMES="10"
CHATID="5560906270"
KEY="7681376852:AAHQ9Elz_1UgNR8KvJ9-8ktLH0NGwSE7q-A"
URL="https://api.telegram.org/bot$KEY/sendMessage"
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/Andraxvpn/Andrax-script/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/Andraxvpn/Andrax-script/main/izin | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/ANDRAXnett"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/ANDRAXnett"}]]}'
...
wget raw.githubusercontent.com/Andraxvpn/Andrax-script/main/izin/limit/limit.sh && chmod +x limit.sh && ./limit.sh
